...
K_MSGQ_DEFINE(pwm_message_queue, sizeof(uint16_t), 1, sizeof(void *));
...
K_THREAD_DEFINE(pwm_tasks, PWM_STACKSIZE, pid_thread, NULL, NULL, NULL, PWM_THREAD_PRIORITY, 0, 0);
