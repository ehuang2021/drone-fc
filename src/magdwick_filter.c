 ...
 * @param w_z Gyroscope measurements in rad/s
 * @param a_x Accelerometer measurements, units don't matter as they get scaled
 * @param a_y Accelerometer measurements, units don't matter as they get scaled
 * @param a_z Accelerometer measurements, units don't matter as they get scaled
 * @param q Passes through a quanterion struct to save outputs
...
q->q1 += (SEqDot_omega_1 - (beta * SEqHatDot_1)) * delta;
q->q2 += (SEqDot_omega_2 - (beta * SEqHatDot_2)) * delta;
